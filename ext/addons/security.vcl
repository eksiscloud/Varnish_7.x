sub sec_headers {
	...
	if (!resp.http.Content-Security-Policy) {
		...
		if (req.http.host ~ "www.katiska.info") {
			set resp.http.x-csp-host = "www.katiska.info cdn.katiska.info meta.katiska.info cdnmeta.katiska.info store.katiska.info cdnstore.katiska.info selko.katiska.info www.koiranravitsemus.fi";
		...
		elseif (req.http.host ~ "store.katiska.info") {
			set resp.http.x-csp-host = "store.katiska.info cdnstore.katiska.info www.katiska.info cdn.katiska.info meta.katiska.info cdnmeta.katiska.info pro.katiska.info";
		...
		elseif (req.http.host ~ "pro.katiska.info") {
			...
			set resp.http.x-child-src = resp.http.x-child-src + " " + "blob:" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src = resp.http.x-script-src + " " + "cdnjs.cloudflare.com/ajax/libs/mathjax/" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + "cdnjs.cloudflare.com/ajax/libs/mathjax/" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			...
			set resp.http.x-media-src = resp.http.x-media-src + " " + "s3-eu-west-1.amazonaws.com/e-matsku/" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-font-src = resp.http.x-font-src + " " + "fonts.googleapis.com" + " " + resp.http.x-csp-host + "; ";
		...
		if (req.http.host ~ "selko.katiska.info") {
			...
			set resp.http.x-child-src = resp.http.x-child-src + " " + "*.youtube.com stats.g.doubleclick.net" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src = resp.http.x-script-src + " " + "cdn.jsdelivr.net platform.twitter.com bam.nr-data.net js-agent.newrelic.com cdnjs.cloudflare.com cdn.mxpnl.com fast.wistia.com beacon-v2.helpscout.net cdn.ampproject.org stats.g.doubleclick.net partner.googleadservices.com tpc.googlesyndication.com pagead2.googlesyndication.com apis.google.com ajax.googleapis.com" + " " + resp.http.x-adservice + " " + resp.http.x-www-google + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + "bam.nr-data.net js-agent.newrelic.com/nr-1210.min.js cdn.ampproject.org/rtv/012108100143000/amp4ads-host-v0.js beacon-v2.helpscout.net fast.wistia.com cdn.mxpnl.com/libs/mixpanel-2-latest.min.js stats.g.doubleclick.net partner.googleadservices.com tpc.googlesyndication.com pagead2.googlesyndication.com apis.google.com ajax.googleapis.com" + " " + resp.http.x-adservice + " " + resp.http.x-www-google + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			...
			set resp.http.x-frame-src = resp.http.x-frame-src + " " + "platform.twitter.com fi.wordpress.org wp.freemius.com wp-rocket.me accounts.google.com pagead2.googlesyndication.com googleads.g.doubleclick.net stats.g.doubleclick.net apis.google.com tpc.googlesyndication.com data:" + " " + resp.http.x-csp-host + "; ";
		...
		elseif (req.http.host ~ "store.eksis.one") {
			...
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + "cdn.mxpnl.com/libs/mixpanel-2-latest.min.js js.klarna.com" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
		...
		if (req.http.host ~ "www.jagster.fi") {
			set resp.http.x-csp-host = "www.jagster.fi kaffein.jagster.fi www.katiska.info cdn.katiska.info meta.katiska.info cdnmeta.katiska.info";
			set resp.http.x-child-src = resp.http.x-child-src + " " + "stats.g.doubleclick.net" + " " + resp.http.x-csp-host + "; ";
			...
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			set resp.http.x-connect-src = resp.http.x-connect-src + " " + "stats.g.doubleclick.net d3hb14vkzrxvla.cloudfront.net embed-fastly.wistia.com embedwistia-a.akamaihd.net endpoint1.collection.us2.sumologic.com bam.nr-data.net fg8vvsvnieiv3ej16jby.litix.io api-js.mixpanel.com distillery.wistia.com pipedream.wistia.com beaconapi.helpscout.net beacon-v2.helpscout.net fast.wistia.com attestation.android.com stats.g.doubleclick.net pagead2.googlesyndication.com" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-frame-src = resp.http.x-frame-src + " " + "platform.twitter.com player.vimeo.com fi.wordpress.org wp.freemius.com wp-rocket.me pagead2.googlesyndication.com googleads.g.doubleclick.net stats.g.doubleclick.net tpc.googlesyndication.com" + " " + resp.http.x-csp-host + "; ";
		...
		if (req.http.host ~ "www.koiranravitsemus.fi") {
			...
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			set resp.http.x-connect-src = resp.http.x-connect-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-frame-src = resp.http.x-frame-src + " " + resp.http.x-csp-host + "; ";
		...
		if (req.http.host ~ "www.ymparistosuunnittelija.com") {
			...
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + "cdn.ampproject.org/rtv/012108100143000/amp4ads-host-v0.js cdn.mxpnl.com/libs/mixpanel-2-latest.min.js stats.g.doubleclick.net partner.googleadservices.com tpc.googlesyndication.com pagead2.googlesyndication.com apis.google.com ajax.googleapis.com" + " " + resp.http.x-adservice + " " + resp.http.x-www-google + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			set resp.http.x-connect-src = resp.http.x-connect-src + " " + "stats.g.doubleclick.net endpoint1.collection.us2.sumologic.com bam.nr-data.net fg8vvsvnieiv3ej16jby.litix.io api-js.mixpanel.com distillery.wistia.com pipedream.wistia.com beaconapi.helpscout.net beacon-v2.helpscout.net fast.wistia.com attestation.android.com stats.g.doubleclick.net pagead2.googlesyndication.com" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-frame-src = resp.http.x-frame-src + " " + "googleads.g.doubleclick.net tpc.googlesyndication.com fi.wordpress.org wp.freemius.com wp-rocket.me pagead2.googlesyndication.com stats.g.doubleclick.net" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-img-src = resp.http.x-img-src + " " + "3.bp.blogspot.com/-Lv9-8o2hzX4/VhYyu9KiHsI/AAAAAAAAALw/JH-V5x8LGds/s400/koirameemi.png i1.wp.com/www.ymparistosuunnittelija.com/wp-content/uploads/2019/09/V%C3%A4ris%C3%A4%C3%A4detty-ajopuu.jpg 3.bp.blogspot.com/-Lv9-8o2hzX4/VhYyu9KiHsI/AAAAAAAAALw/JH-V5x8LGds/s400/koirameemi.png pbs.twimg.com ps.w.org s.w.org dashboard.freemius.com img.freemius.com s0.wp.com www.facebook.com secure.gravatar.com deliciousbrains.com fast.wistia.com embed-fastly.wistia.com wp-rocket.me embedwistia-a.akamaihd.net i.ytimg.com syndication.twitter.com platform.twitter.com play-lh.googleusercontent.com pagead2.googlesyndication.com" + " " + resp.http.x-www-google + " " + resp.http.x-csp-host + "; ";
		...
		if (req.http.host ~ "stats.eksis.eu") {
			...
			set resp.http.x-frame-ancestors = "frame-ancestors www.katiska.info www.eksis.one selko.katiska.info 'self'" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-worker-src = resp.http.x-worker-src + "; ";
			set resp.http.x-upgrade-mixed = resp.http.x-upgrade-mixed + " ";
		}
		...
		if (req.http.host ~ "git.eksis.one") {
			set resp.http.x-csp-host = "git.eksis.one";
			set resp.http.x-child-src = resp.http.x-child-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src = resp.http.x-script-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-elem = resp.http.x-script-src-elem + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-script-src-attr = resp.http.x-script-src-attr + "; ";
			set resp.http.x-connect-src = resp.http.x-connect-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-frame-src = resp.http.x-frame-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-img-src = resp.http.x-img-src + " " + "images.microbadger.com/badges/image/gitea/gitea.svg image.ibb.co/e02dSb/6.png dl.gitea.io/screenshots/ pkg.go.dev/badge/code.gitea.io/ badgen.net/https/api.tickgit.com/badgen/github.com/go-gitea/gitea badges.crowdin.net/gitea/ opencollective.com www.codetriage.com godoc.org goreportcard.com codecov.io img.shields.io drone.gitea.io storage.gitea.io raw.githubusercontent.com" + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-media-src = resp.http.x-media-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-font-src = resp.http.x-font-src + " " + resp.http.x-csp-host + "; ";
			set resp.http.x-style-src = resp.http.x-style-src + " " + resp.http.x-csp-host + "; ";
		...
		if (req.http.host ~ "ymparistosuunnittelija") {
			set resp.http.Content-Security-Policy-Report-Only = resp.http.Content-Security-Policy;
			unset resp.http.Content-Security-Policy;
		}
